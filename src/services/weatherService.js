...
const USE_API_ROUTE = process.env.NODE_ENV !== 'development';
const API_BASE = '/api';
...
export const weatherService = {
  getCurrentWeather: async (location) => {
    try {
      ...
      if (USE_API_ROUTE) {
        // Try to use Vercel API route first (for production)
        try {
          ...
          console.log('Vercel API route failed, falling back to direct API call:', apiRouteError.message);
